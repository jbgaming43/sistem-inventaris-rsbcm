...
class PenerimaanInventarisDetailModel extends Model
{
    protected $DBGroup = 'sik'; // Sesuaikan jika berbeda
    protected $table = 'inventaris_detail_pesan';
    ...
    {
        return $this->select('inventaris_detail_pesan.*, inventaris_barang.*, inventaris_produsen.*, inventaris_merk.*, inventaris_jenis.*')
            ->join('inventaris_barang', 'inventaris_detail_pesan.kode_barang=inventaris_barang.kode_barang')
