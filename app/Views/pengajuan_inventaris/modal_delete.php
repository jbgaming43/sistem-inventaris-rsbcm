        ...
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center py-2">
                    ...
                    <h3>Hapus data</h3>
                    <div class="text-muted">Apakah anda yakin ingin menghapus data <strong><?= $dt_pengajuan_inventaris['no_pengajuan']; ?></strong>?</div>
                </div>
                <div class="modal-footer">
                    <form action="/pengajuan_inventaris/delete/<?= $dt_pengajuan_inventaris['no_pengajuan']; ?>" method="POST">
                        <div class="w-100">
                            <div class="row">
