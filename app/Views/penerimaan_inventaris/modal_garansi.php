<!-- MODAL TAMBAH GARANSI PENERIMAAN INVENTARIS BERDASARKAN NO INVENTARIS -->
    ...
    <div class="modal-dialog modal-full-width modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Tambah Data Garansi Pemesanan Inventaris</h5>
                    ...
                    <div class="mb-2 row">
                        ...
                        <div class="col">
                            <select class="form-select select2-petugas" id="no_inventaris" name="no_inventaris" style="width: 100%" required>
                                ...
                                <?php foreach ($inv_garansi_belum_con as $dt_inv) : ?>
...
<!-- MODAL EDIT GARANSI PENERIMAAN INVENTARIS BERDASARKAN NO INVENTARIS -->
<div class="modal modal-blur fade" id="edit_garansi_penerimaan_inventaris" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-full-width modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Data Garansi Pemesanan Inventaris</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="/penerimaan_inventaris/add_garansi" method="POST" class="validation_penerimaan_inventaris" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="mb-2 row">
                        ...
                        <div class="col">
                            <select class="form-select select2-petugas" id="no_inventaris" name="no_inventaris" style="width: 100%" required>
                                <option value="">- Pilih no inventaris -</option>
                                <?php foreach ($inv_garansi_sudah_con as $dt_inv) : ?>
                                    <option value="<?= $dt_inv['no_inventaris'] ?>"> <?= $dt_inv['no_inventaris'] ?>-<?= $dt_inv['nama_barang'] ?></option>
                                <?php endforeach ?>
                            </select>
                        </div>
